<template>
  <div>
    <div class="post-section">
      ...
      <div class="post-group-section-content">
        ...
        <div class="post-right">
          ...
          <i
            ...
            style="
              background-image: url('https://static.xx.fbcdn.net/rsrc.php/v3/yL/r/SrPSbtGPw_3.png');
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          <span
            >বিষয়টি অবিশ্বাস্য মনে হলেও সত্য বর্তমানে স্টুডেন্টদের মাঝে টিউশনি
            বা পার্ট-টাইম জবের পরিবর্তে জনপ্রিয় হয়ে উঠেছে ফ্রিল্যান্সিং। অনেক
            অভিভাবক ব্যপারটি একটু অন্যভাবে দেখে থাকেন। অভিভাবকদের বলছি একবার
            ভাবুন তো ঘরে বসেই আপনার সন্তান পাড়াশুনার পাশাপাশি আয় করতে পারছে। এই
            কাজে নেই কোন ট্রাফিক জ্যাম বা নিরাপত্তার চিন্তা। ঠিক আয়ের জন্য নয়,
            ফ্রিল্যান্সিং কাজগুলো তারা করেন হয়তো স্বাবলম্বী হওয়ার প্রস্তুতি
            হিসেবে নয়তো হাত খরচের জন্য অথবা নতুন একটা স্কিল অর্জনের জন্য।
            পড়াশুনাটা ঠিক রেখে ফ্রিল্যান্সিং করার আইডিয়াটা কিন্তু এই যুগের
            প্রেক্ষাপটে সঠিক। <br />
            #happyfreelancing_career <br />
            #socialmedia
          </span>
        </p>
        <img src="../img/freelancing.jpg" alt="" />
      </div>
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">Have A Wounderful Time.,,.,.,.,</p>
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          Feelings Better Now.,,Fulfil My Dreams.,.,.,
        </p>
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">That`s Very Beautiful Place.,,.,.,.,</p>
    ...
    <div class="post-section">
      ...
      <div class="post-group-section-content">
        <div class="post-group-content">
          <img src="../img/icons8-male-user-50.png" alt="" />
          <div class="post-body-header">
            <p class="post-header-content">Dhaka Savar, BANGLADESH .</p>
      ...
      <div class="post-long-img">
        <p class="post-title-body">Feelings Better Now.,,.,.,.,</p>
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          Feelings Better Now.,, Have a Wounderful Time.,.,.,
        </p>
    ...
    <div class="post-section">
      ...
      <div class="post-group-section-content">
        <div class="post-group-content">
          <img
            class="jamuna-img"
            src="https://glittering-fenglisu-411425.netlify.app/_nuxt/img/travel.1ab438f.jpg"
            alt=""
          />
          <div class="post-body-header">
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          Feelings Better The Beautiful Place in The World.,.,.,
        </p>
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          Join the Unscripted Laptop Giveway.,,.,.,.,
        </p>

        <img src="../img/group adda.jpg" alt="" />
      </div>
      <hr />
    ...
    <div class="post-section">
      ...
      <div class="post-long-img">
        <p class="post-title-body">
          Not Acceptable For this,,. Very hard Taching Moment,.,.,
        </p>
