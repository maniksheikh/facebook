  ...
  <div>
    <header class="header">
      <div class="logo">
        ...
        <button class="btn btn-mobile-menu" @click="toggleMobileMenu">
          <svg
            v-if="!mobileMenuOpen"
            viewBox="0 0 24 24"
            width="24"
      ...
      <div class="main-link" :class="{ 'mobile-menu-open': mobileMenuOpen }">
        <ul class="items">
      ...
      <div class="right-link">
        <ul class="right-nav-links">
          ...
          <li class="item">
            ...
            <span class="visible">Messenger</span>
          </li>
          <li class="item">
            <nuxt-link to="#">
              <svg
                viewBox="0 0 28 28"
                alt=""
                class="b6ax4al1 m4pnbp5e ahndzqod g8r5yzqk"
                fill="#050505"
                height="20"
                width="20"
              >
            ...
            <button class="btn dropdown">
              ...
              <div v-if="visible" class="dropdown-menu">
                ...
                <div class="btn btn-logout">
                  ...
                  <button class="btn btn-flex" @click.prevent="logout">
                    <div class="item-box">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="mr-t">
                <span class="visible mr-t">Account</span>
              </div>
            </button>
          </li>
        </ul>
