  ...
  <div>
    <div class="crete-post">
      <div class="flex">
        ...
        <input id="" v-model="text" type="text" name="" placeholder="what's on your mind,?" @change="addItem" />
      </div>
      <div class="post-btn">
        <button class="btn">
          ...
          <div class="react-btn">
            <button class="btn btn-react">
              <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" width="20px" height="20px" y="0px"
