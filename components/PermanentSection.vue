  ...
  <div>
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>Have a good Day in Mornig Dhaka.</h3>
        </div>
        <hr />
        <img class="post-img" src="../assets/image/new-post.JPG" />
        <div class="react-btn">
          <button class="btn btn-react">
            <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              x="0px" width="20px" height="20px" y="0px" viewBox="0 0 486.926 486.926"
              style="enable-background: new 0 0 486.926 486.926" xml:space="preserve">
              <g>
          ...
          <button class="btn btn-share">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              width="20px" height="20px" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000"
              xml:space="preserve">
              <metadata>
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>If you Became a good Developer, You Should Hard Work Everyday.</h3>
        </div>
        <hr />
        <img class="post-img" src="../assets/image/freelancing.jpg" />
        <div class="react-btn">
          <button class="btn btn-react">
            <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              x="0px" width="20px" height="20px" y="0px" viewBox="0 0 486.926 486.926"
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>Have a Good Day With My Friends.</h3>
        </div>
        <hr />
        <img class="post-img" src="../assets/image/friends.jpg" />
        <div class="react-btn">
          <button class="btn btn-react">
            <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              x="0px" width="20px" height="20px" y="0px" viewBox="0 0 486.926 486.926"
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>Beautiful Places Iceland I𝐄𝐬𝐩𝐲 𝐓𝐫𝐚𝐯𝐞𝐥 & 𝐓𝐨𝐮𝐫𝐢𝐬𝐦n The World.</h3>
        </div>
        <hr />
        <img class="post-img" src="../assets/image/iceland.jpg" />
        <div class="react-btn">
          <button class="btn btn-react">
            <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              x="0px" width="20px" height="20px" y="0px" viewBox="0 0 486.926 486.926"
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>It`s Very Amazing Place in Mornig , When Sun Rising.</h3>
        </div>
        <hr />
        <img class="post-img" src="../assets/image/beautiful place.jpg" />
        <div class="react-btn">
          <button class="btn btn-react">
            <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              x="0px" width="20px" height="20px" y="0px" viewBox="0 0 486.926 486.926"
