  ...
  <div>
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>Have a good Day in Morning Dhaka.</h3>
        </div>
        <hr />
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>Beautiful Places Iceland - Espy Travel & Tourism in The World.</h3>
        </div>
        <hr />
    ...
    <div class="permanent-section">
      <div class="items">
        ...
        <div class="post-title">
          <h3>It's a Very Amazing Place in Morning, When Sun is Rising.</h3>
        </div>
        <hr />
